			...
			<div class="mainWrapper">
				...
				<div class="mainPosts">
					...
					<form name="frm" action="${pageContext.request.contextPath}/walkBlog/${blogInfoVo.paramCode}/${walkLog.walkLogNo}/modify" method="post">
						...
						<input type="hidden" name="deletedIds" value="" /> <input type="file" style="display: none;" id="imageUpload" onchange="selectedImage(this)" />
							...
							<div class="mainRecord1">
								...
								<div class="MRwalkRecordSection">
									<div class="MRwalkData">
										<img src="${pageContext.request.contextPath}/rdimg/mapImg/산책데이터.png" alt="">
									</div>
