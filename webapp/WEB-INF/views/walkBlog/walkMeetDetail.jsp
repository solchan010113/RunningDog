			...
			<div class="mainWrapper">
				...
				<div class="mainPosts">
					...
					<div class="category">
						...
						<button type="button" class="homeButton" onclick="location.href='${pageContext.request.contextPath}/walkBlog/${requestScope.blogInfoVo.paramCode}?crtPage=1'">홈으로</button></div>
					</div>
