...
public class mobileWebController {
	...
	public String wif(@ModelAttribute MoWalkLogVo moWalkLogVo, Model walkLogModel,
					  ...
					  @RequestParam(name = "dogList") String dogList, Model dogModel,
					  Model trailModel
					  )
		...
		System.out.println("산책한 강아지 번호 " + dogNoList);	
		
		dogModel.addAttribute("dogNoList",dogNoList);
	...
	public String walkInsert(@ModelAttribute MoWalkLogVo moWalkLogVo, HttpSession session, // 산책기록,세션
							 ...
							 @RequestParam(name = "mapImage") String mapImageData, // 맵이미지
							 @RequestParam(name = "images") String imagesData, // 첨부이미지리스트 문자열
