...
public class CoordsVo {
	...
	public CoordsVo(int coordNo, int coordOrder, String type, int useNo, double lat, double lng) {
	...
	public String toString() {
		return "coordsVo [coordNo=" + coordNo + ", coordOrder=" + coordOrder + ", type=" + type + ", useNo=" + useNo
				+ ", lat=" + lat + ", lng=" + lng + "]";
	}
